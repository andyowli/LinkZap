...
export default function PriceClient() {
    ...
    const pricingPlans = [
        {
            ...
            popular: false,
            priceId:'price_1Sycvc2NNWiedX3pbtTTjaxF'
        },
        {
            name: "Professional",
            price: 9.9,
            ...
            popular: true,
            priceId:'price_1SyvAN2NNWiedX3pkhjskeJI'
        },
        {
            name: "Sponsor",
            price: 19.9,
            ...
            buttonVariant: "outline" as const,
            popular: false,
            priceId:'price_1Syvo12NNWiedX3pxjgvz1GL'
        },
    ]
    ...
    const handlePaymentClick = (plan: typeof pricingPlans[0]) => {
        ...
        usePrice.getState().setPrice(plan.price);
